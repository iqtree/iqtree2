    ...
    */
    ...
    /**
            ...
            Method 2: New method
                ...
                c. If the mixture with k+1 classes pass the likelihood ratio test,
            ...
            Method 3: Same as method 2, except using IC values instead of likelihood ratio test in step c.
     */
    int opt_qmix_method;
    
    /**
        The p-value threshold used to optimize the Q-Mixture model when Method 2 is selected. Default = 0.05
     */
