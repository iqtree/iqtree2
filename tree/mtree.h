...
********************************************************/
	 ...
	 */
	void computeRFDist(const char *trees_file, DoubleVector &dist, 
                           int assign_sup = 0);

	void computeRFDist(istream &in, DoubleVector &dist, 
                           int assign_sup = 0, bool one_tree = false);
    ...
    */
    ...
    virtual void logLine(const char* line) const override;
    virtual void logLine(const std::string& line) const override;
...
protected:
    ...
    */
     ...
     */
    string getBranchID(Node* node1, Node* node2);
};
