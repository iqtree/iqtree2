...
*/
int AliSimulatorHeterogeneityInvar::estimateStateFromAccumulatedTransMatrices(double *cache_trans_matrix, double site_specific_rate, int site_index, int num_rate_categories, int dad_state)
{
    ...
    return AliSimulatorHeterogeneity::estimateStateFromAccumulatedTransMatrices(cache_trans_matrix, site_specific_rate, site_index, num_rate_categories, dad_state);
}
