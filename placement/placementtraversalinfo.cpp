...
PlacementTraversalInfo::PlacementTraversalInfo(PhyloTree& tree,
                       PhyloNeighbor* dad_branch,
                       PhyloNode* dad): super(dad_branch,dad), phylo_tree(tree) {
    ...
    size_t lh_leaf_size   = get_safe_upper_limit((phylo_tree.aln->STATE_UNKNOWN+1)*block*2);
